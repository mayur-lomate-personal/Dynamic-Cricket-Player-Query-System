...
public class PlayerSpecification implements Specification<Player> {
    ...
    public PlayerSpecification(final SpecSearchCriteria criteria) {
        super();
    ...
    @Override
    public Predicate toPredicate(final Root<Player> root, final CriteriaQuery<?> query, final CriteriaBuilder builder) {
