...
public class GenericSpecificationsBuilder<U> {
    ...
    //The 2nd argument is constructor reference with 1 parameter
    public Specification<U> build(Deque<?> postFixedExprStack, Function<SpecSearchCriteria, Specification<U>> converter) {
        ...
        while (!postFixedExprStack.isEmpty()) {
            ...
            //We check if this belongs to a string since we have filter expression as specification and operators as string
